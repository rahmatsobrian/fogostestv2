...
clone_anykernel() {
    if [ ! -d "$ANYKERNEL_DIR" ]; then
        ...
        git clone -b fogos https://github.com/rahmatsobrian/AnyKernel3.git "$ANYKERNEL_DIR" || exit 1
    fi
}
...
echo -e "$yellow[+] Sending toolchain info...$white"
send_telegram_tc
